...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/jessonxiang/eros-plugin-ios-baseLibrary"
  s.license      = "MIT"
  s.author       = { "xionghuayu" => "18601949015@163.com" }

  s.platform     = :ios, "8.0"
  s.ios.deployment_target = "8.0"
  s.source       = { :git => "https://github.com/jessonxiang/eros-plugin-ios-baseLibrary.git", :tag => s.version.to_s }
  s.requires_arc = true
